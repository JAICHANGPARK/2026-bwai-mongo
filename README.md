...
문제가 생기면 [최종 체크리스트와 문제 해결](./docs/08-checklist-troubleshooting.md)를 참고하세요.
...
8. [최종 체크리스트와 문제 해결](./docs/08-checklist-troubleshooting.md)
9. [공식 참고 링크](./docs/09-references.md)
