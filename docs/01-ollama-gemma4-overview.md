...
Ollama는 모델 파일과 설정을 사용자 홈 디렉터리 아래에 저장합니다. 모델 파일은 커질 수 있으므로 최소 20GB 이상, 가능하면 40GB 이상 여유 공간을 확보해 주세요.
...
- 사전 준비에서는 `gemma4:e2b`, `gemma4:e4b`, `gemma4:26b`, `gemma4:31b`처럼 명시적 태그를 사용하세요.
